...
def train(train_loader,
    ...
    return best_epoch, min_loss, z_train_epoch, z_test_epoch, y_train_epoch, y_test_epoch
...
if __name__ == '__main__':
    ...
    best_epoch, min_loss, z_train_epoch, z_test_epoch, y_train_epoch, y_test_epoch = train(train_loader, test_loader, input_dim, graph_head, phi, gcn_dim, mlp_dim, prob_feature, prob_edge,
